...
public class DeleteMedicineModel {
	private static final int CHILDID = 6; //Replace when support for several children is possible
	 ...
	 */
	public DeleteMedicineModel(int id, String time, int healthStateId)
	{
		this.medicineId = id;
		this.time= time; 
